...
def _convert_one_sec_data(ukdale_path, store, ac_type_map, drop_duplicates):
    ...
    store.close()
#ukdale_path='C:/Users/ASUS/PycharmProjects/autonialm/data/UKdale/ukdale/'
#output_filename='C:/Users/ASUS/PycharmProjects/autonialm/ukkdale.h5/'

#convert_ukdale(ukdale_path, output_filename, format='HDF', drop_duplicates=True)
convert_ukdale(ukdale_path='/Users/macbook/PycharmProjects/autonialmm/data/UKDALE/ukdale', output_filename='/Users/macbook/PycharmProjects/autonialmm/data/UKDALE/ukdale.h5', format='HDF')
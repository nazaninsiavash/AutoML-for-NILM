...
hd5_filepath = "/Users/macbook/PycharmProjects/automl4nilm/data/UKDALE/ukdale.h5"
train_building = 1
...
################## Main function
#######################################################
def main(args_hd5_filepath ,args_train_building, args_train_start, args_train_end,args_val_building, args_val_start, args_val_end, args_test_building , args_test_start ,args_test_end ,args_appliance ,args_downsampling_period, args_max_evals, args_metrics_to_optimize, args_num_epochs, args_patience):
    ...
    val_building = args_val_building
    val_start = pd.Timestamp(args_val_start)
    val_end = pd.Timestamp(args_val_end)
    ...
    with open('results/trial-metadata-{}-{}-{}.json'.format(appliance, downsampling_period, metrics_to_optimize),
              'w+') as outfile:
    ...
    with open('results/trial-results-{}-{}-{}.json'.format(appliance, downsampling_period, metrics_to_optimize),
              'w+') as outfile:
...
main(hd5_filepath ,train_building, train_start, train_end,val_building, val_start, val_end, test_building , test_start ,test_end ,appliance ,downsampling_period,max_evals, metrics_to_optimize, num_epochs, patience)
